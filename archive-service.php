    ...
    <section class="relative w-full min-h-[60vh] overflow-hidden flex flex-col pt-20">
        ...
        <div class="relative z-10 flex-1 flex items-center px-4 md:px-8 py-8">
            <div class="max-w-7xl w-full text-white">
                ...
                <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-[68px] leading-[110%] font-bold mt-3">Our Services</h1>
                <p class="text-lg sm:text-xl lg:text-2xl mt-4 max-w-2xl">From kitchen remodels to custom home builds, we offer a full range of renovation and construction services.</p>
            </div>
        </div>
    </section>
